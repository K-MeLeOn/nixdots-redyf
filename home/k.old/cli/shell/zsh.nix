{
  ...
  programs.zsh = {
    ...
    initExtra = ''
      ...
      export PATH="$PATH:/home/k/.nix-profile/bin/elixir"
      export PATH="$PATH:/home/k/.nix-profile/bin/swww"
      export PATH="$PATH:/home/k/.nix-profile/bin/swww-daemon"
      export PATH="$PATH:$FORGIT_INSTALL_DIR/bin"
      export PATH="$PATH:/home/k/.config/nvim/bin"
    ...
    shellAliases = {
      ...
      mv = "mv -i";
      rip = "rip -i";
      rebuild = "cd ~/flake && doas nixos-rebuild switch --flake .#k --impure";
